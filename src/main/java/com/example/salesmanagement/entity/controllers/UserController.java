...
public class UserController {
    ...
    public ResponseEntity<String> uploadUserImage(@PathVariable("id") String id, @RequestParam("file") MultipartFile file) {
        try {
            ...
            String fileUrl = "http://localhost:1707/" + fileName; // replace with your domain name
    ...
    public ResponseEntity<String> updateUserImage(@PathVariable String id, @RequestParam("file") MultipartFile file) {
        try {
            String fileName = userService.updateUserImage("C:\\Users\\nguye\\Learn Springboot\\salesmanagement\\images\\Users", id, file);
            String fileUrl = "http://localhost:1707/" + fileName; // modify this URL with your actual domain and image folder path
            return ResponseEntity.ok(fileUrl);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public ResponseEntity<String> deleteUserImage(@PathVariable String id) {
        boolean deleted = userService.deleteUserImage("C:\\Users\\nguye\\Learn Springboot\\salesmanagement\\images\\Users", id);
        if (deleted) {
    ...
    public ResponseEntity<byte[]> getUserImage(@PathVariable String id) {
        try {
            byte[] imageBytes = userService.getUserImage("C:\\Users\\nguye\\Learn Springboot\\salesmanagement\\images\\Users", id);
